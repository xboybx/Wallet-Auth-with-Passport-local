...
// Route to register a new user with file upload
router.post('/register', upload.single('profilePicture'), (req, res) => {
  // Handle file upload here if needed
  const profilePictureUrl = req.file ? `/uploads/profiles/${req.file.filename}` : '/default_profile_picture.jpg'; // Default profile picture URL if no file is uploaded
